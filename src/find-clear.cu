...
__global__ void findAngleOffCenterKernel(float* minXG, float* maxXG, float* minZG, float* maxZG, int numClusters, float* bearing, int direction) {
...
__global__ void findClearPathKernel(float* minXG, float* maxXG, float* minZG, float* maxZG, int numClusters, float* leftBearing, float* rightBearing) {
